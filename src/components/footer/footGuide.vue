    ...
    >
      <svg class="icon_style">
        <use
          xmlns:xlink="http://www.w3.org/1999/xlink"
          :xlink:href="
            $route.path.indexOf('msite') !== -1 ? '#msiteActive' : '#msite'
          "
        ></use>
      </svg>
      <span>外卖</span>
    ...
    >
      <svg class="icon_style">
        <use
          xmlns:xlink="http://www.w3.org/1999/xlink"
          :xlink:href="
            $route.path.indexOf('search') !== -1 ? '#findActive' : '#find'
          "
        ></use>
      </svg>
      <span>搜索</span>
    ...
    <section @click="gotoAddress('/order')" class="guide_item">
      <svg class="icon_style">
        <use
          xmlns:xlink="http://www.w3.org/1999/xlink"
          :xlink:href="
            $route.path.indexOf('order') !== -1 ? '#orderActive' : '#order'
          "
        ></use>
      </svg>
      <span>订单</span>
...
export default defineComponent({
  ...
  setup() {
    ...
    let geohash = computed(() =>  store.state.geohash)
    console.log(geohash)
    return {
      geohash
    };
